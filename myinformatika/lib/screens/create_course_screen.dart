...
class CreateCourseScreen extends StatefulWidget {
  final ECourseModel? course; // if provided -> edit mode
...
class _CreateCourseScreenState extends State<CreateCourseScreen> {
  ...
  void initState() {
    ...
    if (widget.course != null) {
      ...
      _thumbnailUrlController.text = c.thumbnailUrl ?? '';
    }
  }
  ...
  Future<void> _createCourse() async {
    ...
    try {
      ...
      if (widget.course != null) {
        ...
        await _firebaseService.updateECourse(updated);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.course != null ? 'Edit Course' : 'Create New Course'),
        centerTitle: true,
      ),
